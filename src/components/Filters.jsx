  ...
  return (
    <div className="flex flex-col gap-4 mb-8">
      <label className="flex flex-col w-full h-12 relative cursor-text group">
        <div className="flex w-full items-stretch rounded-xl h-full bg-white border border-gray-200 shadow-sm group-focus-within:border-[#26844D] group-focus-within:ring-2 group-focus-within:ring-[#26844D]/20 transition-all">
