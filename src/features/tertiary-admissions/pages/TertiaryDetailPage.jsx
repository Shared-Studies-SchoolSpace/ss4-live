...
import { PlayerProfile } from '../../chess-league/components/PlayerProfile';
...
export default function TertiaryDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchSchoolPlayers = async () => {
      ...
      try {
        ...
        console.error("Error fetching university players:", err);
      } finally {
  ...
  const schoolBio = school?.bio || `${schoolName} is a premier higher education institution in the SCL network committed to nurturing academic leaders and competitive gaming excellence.`;
  // School anthem fallback
  const schoolAnthem = school?.anthem || "Excellence in learning, honor in play, leading with integrity day by day.";
  ...
  return (
    <div className="w-full bg-brand-bg-cream min-h-screen pb-16">
      ...
      <main className="px-6 lg:px-10 py-12 max-w-[1400px] mx-auto space-y-12">
        <UniversityHeader school={school} registeredCount={players.length} />

        {/* Bio & Anthem Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Bio Section */}
          <div className="lg:col-span-2 varsity-card p-8 text-left">
            <h2 className="text-[#111111] text-xl font-bold mb-4 font-space uppercase tracking-wider">About the Institution</h2>
          ...
          {/* Anthem Section */}
          <div className="varsity-card p-8 flex flex-col justify-center text-center">
          ...
          <div className="varsity-card p-8 space-y-6">
            <div className="border-b border-gray-100 pb-4 flex items-center justify-between flex-wrap gap-2">
              <div className="text-left">
                ...
                <p className="text-gray-500 text-xs font-medium mt-1 font-semibold font-space">Live aggregated metrics updated automatically after each SCL tournament.</p>
              </div>
        ...
        <div className="varsity-card p-8 space-y-6">
          <div className="border-b border-gray-100 pb-4 text-left">
            ...
            <p className="text-gray-500 text-xs font-medium mt-1">Students of this institution registered and active in the SCL league.</p>
          </div>
          ...
          {loadingPlayers ? (
            ...
            <div className="text-center py-16 bg-brand-bg-cream/35 rounded-2xl border border-dashed border-gray-250">
              ...
              <p className="text-xs font-bold text-gray-400 italic">No registered players found for this institution yet.</p>
            </div>
          ) : (
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-250 pb-4 text-left">
            <h2 className="text-[#111111] text-xl font-black font-space uppercase tracking-wider">Academic Departments</h2>
            <p className="text-gray-500 text-xs font-medium mt-1 font-semibold">Departments active in the SS4 academic network.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            {school?.departments?.map((dept, index) => (
              <div key={index} className="varsity-card p-6 flex flex-col justify-between">
                <div>
