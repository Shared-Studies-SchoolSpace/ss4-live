    ...
    <>
      ...
      <SectionWrapper variant="default">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <BodyLarge className="mt-6">
            SS4 is the social-learning marketplace for students and graduates to
            share and monetize notes, study guides, and more.
          </BodyLarge>
      ...
      <SectionWrapper variant="white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card
            ...
            title="Resource Sharing & Monetization"
          >
          ...
          <Card
            ...
            title="Structured Content Discovery"
          >
            Find exactly what you need by filtering by university, course, or
            topic. Connect with peers and discover trending content.
          </Card>
      ...
      <SectionWrapper variant="light">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-8">
            <Button variant="primary">Create Your Free Account</Button>
          </div>
        </div>
      </SectionWrapper>
    </>
